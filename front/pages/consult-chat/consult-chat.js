...
Page({
  ...
  getcomment() {
    wx.request({
      url: 'https://knowclear.top/knowclear/consult-comment/getConsultComments/' + this.data.urlconsultId,
      method: "POST",
      data: {},
      header: {
  ...
  databack:function(e){
    ...
          this.setData({isAnonymous:this.data.comments[id].isAnonymous})
          this.setData({backname:this.data.comments[id].account.nickname})
          this.setData({backid:this.data.comments[id].commentId})
  ...
  comment() {
    ...
    setTimeout(function () {
      if (that.data.safe) {
        ...
        wx.request({
          url: 'https://knowclear.top/knowclear/consult-comment/addConsultComment',
          method: "POST",
          data: {
            "parentId": backid,
  ...
  getTopic() {
    const token = wx.getStorageSync('acc_token');
    wx.request({
      url: 'https://knowclear.top/knowclear/consult/getOneConsult/' + this.data.urlconsultId,
      method: "POST",
      data: {},
      header: {
        'Content-Type': 'application/json',
  ...
  upvote() {
    ...
    wx.request({
      url: 'https://knowclear.top/knowclear/consult-upvote/upvoteConsult/' + this.data.urlconsultId,
      method: "POST",
      data: {},
      header: {
        'Content-Type': 'application/json',
  ...
  cancleupvote() {
    ...
    wx.request({
      url: 'https://knowclear.top/knowclear/consult-upvote/cancelUpvote/' + this.data.urlconsultId,
      method: "POST",
      data: {},
      header: {
        'Content-Type': 'application/json',
