...
Page({
  ...
  submitEvent: function (event) {
    ...
    // 标签号
    const chooseLable = wx.getStorageSync('chooseLabel');
    that.setData({
      chooseLable: chooseLable
    });
    ...
    console.log("txt:", that.data.mycontent);
     //敏感词检测
     wx.showToast({
      title: '内容检测中，请稍后。。。',
      icon: 'none',
    ...
    that.sensitive();
    setTimeout(function () { if(that.data.safe){
