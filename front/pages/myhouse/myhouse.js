...
Page({
    ...
    //     wx.request({
    //       //  url: api.getUrl('/knowclear/label/selectLabelByOpenId/'+this.data.current+'/8',
    //       url: api.getUrl('/knowclear/label/selectLabelByOpenId/'),
    //       method:"GET",
    //       header: {       //下面是固定格式，照搬
    ...
    getTopicList_0(){
      ...
      var that = this;
      wx.request({  
        // url: api.getUrl('/knowclear/label/selectLabelByOpenId/0/8',
        url: api.getUrl('/knowclear/label/selectLabelByOpenId'),
        method:"GET",
        data:{},
        header: {       //下面是固定格式，照搬
