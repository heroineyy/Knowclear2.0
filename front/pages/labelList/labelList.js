...
Page({
    ...
    onReachBottom: function () {
      ...
      if(this.data.isShow == true){  
        ...
        wx.request({
          url: 'https://knowclear.top/knowclear/label/selectAllLabelByCollegeId/'+collegeid+'/0/'+this.data.current+'/5',
          success:(res)=>{
    ...
    getTopicList_0(){
      ...
      var that = this;
      wx.request({   // 首次请求商品列表
        url:'https://knowclear.top/knowclear/label/selectAllLabelByCollegeId/'+collegeid+'/0/0/5',
    ...
    chosen:function(e){
      ...
      // wx.setStorageSync({
      //             key: "chooseLable",
      //             data: e.currentTarget.dataset.item.labelId
      //           })
      // wx.setStorageSync({
      //     key: "labelName",
      //     data: e.currentTarget.dataset.item.name
      // })
