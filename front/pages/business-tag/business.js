...
Page({
    ...
    onReachBottom: function () {
      ...
      if(this.data.isShow == true){  
        ...
        wx.request({
          url: 'https://knowclear.top/knowclear/label/selectAllLabelByCollegeId/'+collegeid+'/1/'+this.data.current+'/5',
          success:(res)=>{
    ...
    getTopicList_0(){
      ...
      wx.request({   // 首次请求，一次请求9页
        url:'https://knowclear.top/knowclear/label/selectAllLabelByCollegeId/'+collegeid+'/1/0/5',
